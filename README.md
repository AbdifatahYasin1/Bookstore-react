...
**[Bookstore React App:: setup]** It is Bookstore React App using React js.
...
- On the terminal run this command git clone `https://github.com/AbdifatahYasin1/Bookstore React App.git`
...
2. - [ ] Run `https://github.com/AbdifatahYasin1/Bookstore React App.git`
